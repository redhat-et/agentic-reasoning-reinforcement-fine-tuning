"""
Wordle Reward Functions for GRPO Training

This module contains reward functions for training language models on Wordle-style tasks
using Group Relative Policy Optimization (GRPO). These functions evaluate different aspects
of generated completions in the Wordle domain.

Based on techniques from:
- DeepSeekMath paper (format rewards)
- Predibase and DeepLearning.AI course on reinforcement fine-tuning
...
# Reward function that checks the output format, e.g. thinking, guessing tags
...
# Reward hyperparameters are unchanged from the original scripts.
